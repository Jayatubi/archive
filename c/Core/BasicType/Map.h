...
namespace GX
{
    ...
    class Map : public std::map<_KeyType, _ValueType>
    {
    public:
        typedef _KeyType KeyType;
        typedef _ValueType ValueType;
        typedef std::map<KeyType, ValueType> BaseType;
        // typedef std::function<bool(const KeyType&, const ValueType&)> PredicateType;
